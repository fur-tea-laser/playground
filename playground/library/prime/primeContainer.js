 ...
 * ```
 */
export function primeContainer(containerIndex) {
    return (primeContainerSequence(containerIndex)[containerIndex] ??
 ...
 * ```
 */
export function primeContainerSequence(maxContainerIndex) {
