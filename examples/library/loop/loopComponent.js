 ...
 */
export function loopCosine(someLoopPoint) {
    return someLoopPoint[0] - someLoopPoint[6];
}
/**
 * great for generating sine waves of a loop
 */
export function loopSine(someLoopPoint) {
    return someLoopPoint[1] - someLoopPoint[7];
}
/**
 * great for generating pendulum waves of a loop
 */
export function loopPendulum(someLoopPoint) {
    const outputLoopAngle = Math.atan2(someLoopPoint[1] - someLoopPoint[7], someLoopPoint[0] - someLoopPoint[6]);
    const outputBaseAngle = Math.atan2(someLoopPoint[3] - someLoopPoint[7], someLoopPoint[2] - someLoopPoint[6]);
