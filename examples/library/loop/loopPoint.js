 ...
 */
export function loopPoint(loopStructure, inputAngle) {
    let subCircleDepth, subCircleX, subCircleY, subPointX, subPointY, originX, originY, terminalPointX, terminalPointY, basePointX, basePointY, deltaX, deltaY, squaredDeltaAdded, exprA, exprB, exprC, orientationCos, orientationSin, rotationCos, rotationSin, rotateDeltaX, rotateDeltaY = NaN;
    const pointResult = new Float64Array(8);
