...
U64 calcMaxIdatCompressedPixelsSize(
	U32 pixelsWidth, 
	U32 pixelsHeight
) {
...
U64 maxsizeofRgb8bitPngEncoding(
	U32 pixelsWidth, 
	U32 pixelsHeight
) {
...
IendSignatureCrc* atIendSignatureCrc(
	U8* pngEncoding, 
	IdatCompressedPixelsSize idatCompressedPixelsSize
) {
...
void encodeRgb8bitPngPixels(
  ...
  *atIendSignatureCrc(pngEncoding, idatCompressedPixelsSize) =
    swapEndianU32(
      crc32(
        0,
        (Bytef*)atIendSignature(
        	pngEncoding, 
        	idatCompressedPixelsSize
        ),
